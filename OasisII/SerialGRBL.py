...
class GRBL(serial.Serial):
    def __init__(self):
        ...
        self.motion_state_index_limit = 150 #the max index number
        ...
        self.nl_piston_clearance = 0.0 #how much the pistons lower after a new layer to clear the spreader
        ...
        self.nl_end_tolerance = 3.0 #how close to the end pos the gantry needs to be to consider new layer done
        ...
        self.printer_homing_pulloff = 3 #how much the printer steps back after a home
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        temp_x = input("X: ")
        temp_y = input("Y: ")
        printer.SerialGotoXY(temp_x, temp_y, 20000)
