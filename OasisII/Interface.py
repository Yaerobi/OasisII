...
class Interface(QWidget):
    ...
    def initUI(self):	
        ...
        #set labels
        self.motion_title = QLabel('Conexión de Motores', self)
        self.inkjet_title = QLabel('Conexión de Cabezal HP45', self) 
        self.image_title = QLabel('Imagen', self) 
        self.motion_function_title = QLabel('Funciones de movimiento', self)   
        self.inkjet_function_title = QLabel('Funciones de impresión', self)
        
        self.motion_x_pos_title = QLabel('Posición de X', self)
        self.motion_y_pos_title = QLabel('Posición de Y', self)
        self.motion_f_pos_title = QLabel('-', self)
        self.motion_b_pos_title = QLabel('Posición de Z', self)
        self.motion_state_title = QLabel('Estado', self)
        
        self.inkjet_pos_title = QLabel('Posición', self)
        self.inkjet_temp_title = QLabel('Temperatura', self)
        self.inkjet_writeleft_title = QLabel('Escritura de Buffer', self)
        self.threshold_slider_value = QLabel('Threshold: 160', self)
        self.layer_slider_value = QLabel('Layer: 0', self)
        self.dpi_title = QLabel('DPI', self)
        
        #Set buttons	
        self.motion_connect = QPushButton('Conectar', self)
        self.motion_send_line = QPushButton('Enviar', self)
        self.inkjet_connect = QPushButton('Conectar', self)
        self.inkjet_send_line = QPushButton('Enviar', self)
        self.motion_home = QPushButton('Home', self)
        self.motion_goto_home = QPushButton('Go to Home', self)
        ...
        self.inkjet_set_density = QPushButton('Densidad', self)
        self.inkjet_test_button = QPushButton('Testear DPI', self)
        self.file_open_button = QPushButton('Abrir', self)
        ...
        self.center()
        self.setWindowTitle('A-PRINTER CONTROLADOR')
